...
|-----|------------|-----------------|
| SDR Town | **v0.2.76** | `SdrTownControl-0.2.76-win64.dll` |
| FUBAR | **v1.1.39** | Matching 0.2.76 DLL. Website: P25/RDS/tones/SSTV, Take control, SDRplay, satcom (no home lat/lon), aircraft, Inmarsat prototype (no voice follow). |
...
## Tester pairing for 0.2.76 / 1.1.39

1. Install Town **0.2.76** and FUBAR **1.1.39**.
2. Confirm `SdrTownControl.dll` beside `FUBAR.exe` is from 0.2.76.
