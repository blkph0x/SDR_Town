...
static void p25SeedPhase2TrafficOffsetFromControl(Receiver& rx,
                                                  double offsetHz,
...
static size_t p25VoiceDecodeMaxPendingJobsNow(bool speakerSustainHint) noexcept
{
...
static int p25Phase2StreamingDdcEnvOverride() noexcept
{
...
static bool p25Phase2StreamingDdcExperimentEnabled()
{
...
static QJsonArray diagnosticsSystemHealthPressureReasons(const QJsonObject& payload)
{
    QJsonArray reasons;
...
static QString diagnosticsSystemHealthPressureSummary(const QJsonArray& reasons)
{
    QStringList parts;
...
// CLI batch + runCLI: see CliApp.h (ISS-0004 Phase 7)
