...
checks = {
    ...
    'phase2 bridge deeper target': 'outRate * 0.360' in main.split('pushP25Phase2PlayoutBridge', 1)[1][:1600],
    'phase2 bridge faster refill': 'outRate * 0.120' in main.split('pushP25Phase2PlayoutBridge', 1)[1][:1800],
    'phase2 bridge longer active-clear cap': 'consecutivePlayoutBridgeFrames >= 90' in main,
    ...
    'top-up helper reports pushed samples': 'static size_t p25TopUpSpeakerPlaybackRing' in main and 'return totalPushed;' in main.split('static size_t p25TopUpSpeakerPlaybackRing', 1)[1][:2200],
    ...
    'speaker sustain multi-burst hop': 'kP25Phase2VoiceDecodeSpeakerSustainChunkSeconds = 0.140' in main,
