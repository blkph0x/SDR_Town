...
checks = {
    ...
    'Explicit clear grant queues until traffic PTT/ESS': 'cleargranttargetreleaseallowed' not in main_l and 'p25phase2explicitcleargrantvoicereleaseevidence' not in main_l and 'explicit-clear-grant-target-release' not in main and 'const bool grantMayProbeVoice = grantClearTrusted || grantUnknownProbe;' in main and 'establishedClearCall' in main and 'out.phase2TargetSessionAudioRelease' in main,
