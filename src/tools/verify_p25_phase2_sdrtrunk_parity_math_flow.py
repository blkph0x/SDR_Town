...
checks = {
    ...
    'Explicit clear grant validates target AMBE before release': 'cleargranttargetreleaseallowed' not in main_l and 'p25phase2explicitcleargrantvoicereleaseevidence' in main_l and 'releasePendingRawVoiceFromValidatedExplicitClearGrant' in main and 'explicit-clear-grant-target-release' not in main and 'explicit-clear-grant-validated-release' in main and 'phase2DiagnosticAmbeProbeAccepted >= kP25Phase2ExplicitClearGrantProbeMinFrames' in main and 'const bool grantMayProbeVoice = grantClearTrusted || grantUnknownProbe;' in main and 'establishedClearCall' in main and 'out.phase2TargetSessionAudioRelease' in main,
