...
checks = {
    ...
    'explicit clear grant validates target AMBE before release': 'p25Phase2ExplicitClearGrantVoiceReleaseEvidence' in main and 'releasePendingRawVoiceFromValidatedExplicitClearGrant' in main and 'explicit-clear-grant-target-release' not in main and 'explicit-clear-grant-validated-release' in main and 'phase2DiagnosticAmbeProbeAccepted >= kP25Phase2ExplicitClearGrantProbeMinFrames' in main and 'const bool grantMayProbeVoice = grantClearTrusted || grantUnknownProbe;' in main,
