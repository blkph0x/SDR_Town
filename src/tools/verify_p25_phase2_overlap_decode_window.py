...
assert 'kP25Phase2VoiceDecodeSustainOverlapSeconds = 0.080' in text, 'Locked sustain should keep bounded pre-roll after acquisition'
...
assert 'kP25Phase2VoiceDecodeSpeakerSustainOverlapSeconds = 0.080' in text, 'Speaker sustain should preserve one bounded near-live context slice'
