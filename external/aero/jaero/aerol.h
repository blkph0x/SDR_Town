...
signals:
    ...
    // SDR Town: framing evidence, independent of presentation/database lookup.
    void ValidatedSignalUnit(const QByteArray &su);
    void CFrame(const QByteArray &voice, int validUnits);
    void CrcResult(bool valid);
public slots:
    void advanceSecond() { updateDCD(); }
