...
| | |
|---|---|
| **Current version** | **0.2.76** (experimental channel) |
...
5. Place a **matching** `SdrTownControl.dll` next to `FUBAR.exe`. Copy this Town release’s `SdrTownControl-0.2.76-win64.dll` and rename it `SdrTownControl.dll`. See [pairing versions and gaps](docs/FUBAR_PAIRING.md).
