...
Live SSTV development has a tested bounded input queue and streaming helper
transport; receiver/GUI integration and rate conversion are not yet available.
