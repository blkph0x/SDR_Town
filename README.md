...
| | |
|---|---|
| **Current version** | **0.2.75** (experimental channel) |
...
5. Place a **matching** `SdrTownControl.dll` next to `FUBAR.exe`. Copy this Town release’s `SdrTownControl-0.2.75-win64.dll` and rename it `SdrTownControl.dll`. FUBAR GitHub Latest (**1.1.33**) still ships the **0.2.66** DLL — replace it when pairing with 0.2.75. See [pairing versions and gaps](docs/FUBAR_PAIRING.md).
