...
**[Download 0.2.99 portable testing release](https://github.com/blkph0x/SDR_Town/releases/tag/v0.2.99)**
...
Tune/Start applies it. See [release notes](docs/RELEASE_0.2.99.md).
...
| | |
|---|---|
| **Current version** | **0.2.99** portable testing release; **0.2.96** signed updater |
